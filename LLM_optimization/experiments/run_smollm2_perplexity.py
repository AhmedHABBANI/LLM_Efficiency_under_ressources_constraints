...
def main():
    ...
    print("\n===== SMOLLM2 PERPLEXITY RESULTS =====")
    print(json.dumps(results, indent=4))

    with open("results/smollm2_perplexity_results.json", "w", encoding="utf-8") as f:
        json.dump(results, f, indent=4, ensure_ascii=False)

    print("\nResults saved to results/smollm2_perplexity_results.json")
